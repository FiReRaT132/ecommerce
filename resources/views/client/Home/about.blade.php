        ...
        <div class="container py-lg-5">
            <div class="welcome-grids row">
                    <div class="col-lg-6 mb-lg-0 mb-5">
                        <h3 class="hny-title">Giới thiệu về LapTop Shop</h3>
                        <p class="my-4">Xuất thân từ cửa hàng kinh doanh máy tính được thành lập từ năm 2000, Phong Vũ được biết đến là đơn vị bán lẻ lâu đời và uy tín tại Việt Nam. LAPTOP SHOP chuyên kinh doanh các sản phẩm công nghệ thông tin, thiết bị giải trí game, thiết bị văn phòng và thiết bị hi-tech của nhiều nhãn hàng lớn như Dell, Asus, HP, MSI, Lenovo…</p>
                        <p class="mb-4">Sau gần 20 năm phát triển không ngừng, LAPTOP SHOP hướng đến mục tiêu không chỉ là nơi kinh doanh máy tính mà còn là nơi khách hàng có thể tìm thấy mọi tiện ích công nghệ hiện đại và dịch vụ chất lượng cao.</p>
                    </div>
    ...
    <div class="team py-5">
        <div class="container py-lg-5">
            <h3 class="hny-title text-center">
                Đội Ngũ<span> LAPTOP SHOP</span></h3>
            <div class="row team-row mt-5">
                ...
                <div class="col-lg-4 col-sm-6 mb-lg-0 mb-4 team-wrapper position-relative">
                    ...
                    <div class="team_info mt-3 position-absolute">
                        <h3><a href="#" class="team_name">Sơn Tùng</a></h3>
                ...
                <div class="col-lg-4 col-sm-6 team-wrapper position-relative">
                    ...
                    <div class="team_info mt-3 position-absolute">
                        <h3><a href="#" class="team_name">Mạnh Tiến</a></h3>
